...
impl WindowSettings {
    ...
    pub fn from_display(display: &glutin::WindowedContext<glutin::PossiblyCurrent>) -> Self {
    ...
    pub fn restore_positions(&self, display: &glutin::WindowedContext<glutin::PossiblyCurrent>) {
